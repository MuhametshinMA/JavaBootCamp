...
public class Program {
  ...
  public static void drawScore(int score, int currentWeek) {
  ...
  public static long collectScoreToLong(long score, int minScore, int countWeeks) {
    return (long) Math.pow(10, countWeeks) * minScore + score;
  }
